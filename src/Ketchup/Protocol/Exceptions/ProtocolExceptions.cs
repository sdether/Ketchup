...
namespace Ketchup.Protocol.Exceptions {
	...
	public class OperationNotSupportedException : ProtocolException {
		public OperationNotSupportedException(string key, Op op, string server) :
